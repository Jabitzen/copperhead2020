        ...
        telemetry.update();
            ...
            while (opModeIsActive()) {
                ...
                if (skyStonePos == "center") {
                    ...
                    robot.grabberB.setPosition(0.98); // Drop grabberB
                    sleep(2000);
                    ...
                    robot.grabberB.setPosition(.5); // grabberB lets go of stone
                    ...
                    robot.grabberB.setPosition(0.98); // drop grabberB do hold stone
                    sleep(1000);
                    ...
                    robot.grabberB.setPosition(.5); // Drop the stone
                    sleep(500);
                    ...
                    robot.grabberB.setPosition(.98); // drop grabberB do hold stone
                    sleep(1000);
                    ...
                    robot.grabberB.setPosition(.98); // Drop grabberB
                    sleep(1900);
